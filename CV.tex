...
\colorlet{awesome}{awesome-darkskyblue}
% Uncomment if you would like to specify your own color
% \definecolor{awesome}{HTML}{CA63A8}

% Colors for text
% Uncomment if you would like to specify your own color
\definecolor{darktext}{HTML}{660033}
...
\photo{profile.jpg}
\name{Daniele}{Giachetto}
\position{Back-end Developer{\enskip\cdotp\enskip}Cybersecurity Student}
%\address{42-8, Bangbae-ro 15-gil, Seocho-gu, Seoul, 00681, Rep. of KOREA}

% \mobile{(+82) 10-9030-1843}
\email{work@danielegiachetto.com}
%\dateofbirth{January 1st, 1970}
\homepage{www.danielegiachetto.com}
\github{RakuJa}
...
\makecvfooter
{\today}
{Daniele Giachetto~~~·~~~Curriculum Vitae}
{\thepage}
