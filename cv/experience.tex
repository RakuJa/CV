...
\begin{cventries}
  ...
  {Italy} % Location
  {Oct. 2024 - Jun. 2025} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
    \item {Operating Systems \& Networking. The subject covered a wide range of topic, spanning from computer architecture and low-level programming in assembly to the fundamentals of telecommunication and digital/analog signal processing.}
    \item {TPSIT. The subject mainly covered: Clean code, Unit testing, Concurrent programming, Web services, Network programming and a brief introduction to AI and data analysis.}
    \end{cvitems}
  }
  ...
  {Oct. 2021 - Oct. 2023} % Date(s)
  {
    ...
    \item {Designed and developed a micro-service responsible of
        ...
        underneath with as little refactor as possible.}
    ...
    \item {Deployed static analysis tools in every python project, to
        ...
        and cutting down development time.}
    \end{cvitems}
  }
